...
This project implements the [middle-square method](https://en.wikipedia.org/wiki/Middle-square_method) pseudorandom number (PRNG) algorithm to generate some pseudorandom noise and visuals!
...
The video was created by running:
```
python middle-square.py
ffmpeg -i animation.mp4 -i output.wav -c:v copy -c:a aac -shortest middle-square.mp4
```

<em>Note: do not treat this code as final grade production code. I am using this script to take notes and learn basics about  sound.</em>
